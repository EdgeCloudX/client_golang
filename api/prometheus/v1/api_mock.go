...
func (m *MockAPI) AlertManagers(ctx context.Context) (AlertManagersResult, error) {
	m.ctrl.T.Helper()
...
func (m *MockAPI) Alerts(ctx context.Context) (AlertsResult, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Alerts", ctx)
	ret0, _ := ret[0].(AlertsResult)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockAPI) Buildinfo(ctx context.Context) (BuildinfoResult, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Buildinfo", ctx)
	ret0, _ := ret[0].(BuildinfoResult)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockAPI) Config(ctx context.Context) (ConfigResult, error) {
	m.ctrl.T.Helper()
...
func (m *MockAPI) Flags(ctx context.Context) (FlagsResult, error) {
	m.ctrl.T.Helper()
...
func (m *MockAPI) LabelNames(ctx context.Context, matches []string, startTime, endTime time.Time) ([]string, Warnings, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "LabelNames", ctx, matches, startTime, endTime)
	ret0, _ := ret[0].([]string)
	ret1, _ := ret[1].(Warnings)
	ret2, _ := ret[2].(error)
...
func (m *MockAPI) LabelValues(ctx context.Context, label string, matches []string, startTime, endTime time.Time) (model.LabelValues, Warnings, error) {
	m.ctrl.T.Helper()
...
func (m *MockAPI) Metadata(ctx context.Context, metric, limit string) (map[string][]Metadata, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Metadata", ctx, metric, limit)
	ret0, _ := ret[0].(map[string][]Metadata)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockAPI) Query(ctx context.Context, query string, ts time.Time, opts ...Option) (model.Value, Warnings, error) {
	m.ctrl.T.Helper()
...
func (mr *MockAPIMockRecorder) Query(ctx, query, ts interface{}, opts ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockAPI) QueryExemplars(ctx context.Context, query string, startTime, endTime time.Time) ([]ExemplarQueryResult, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "QueryExemplars", ctx, query, startTime, endTime)
	ret0, _ := ret[0].([]ExemplarQueryResult)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockAPI) QueryRange(ctx context.Context, query string, r Range, opts ...Option) (model.Value, Warnings, error) {
	m.ctrl.T.Helper()
...
func (mr *MockAPIMockRecorder) QueryRange(ctx, query, r interface{}, opts ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockAPI) Rules(ctx context.Context) (RulesResult, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Rules", ctx)
	ret0, _ := ret[0].(RulesResult)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockAPI) Runtimeinfo(ctx context.Context) (RuntimeinfoResult, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Runtimeinfo", ctx)
	ret0, _ := ret[0].(RuntimeinfoResult)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockAPI) Series(ctx context.Context, matches []string, startTime, endTime time.Time) ([]model.LabelSet, Warnings, error) {
	m.ctrl.T.Helper()
...
func (m *MockAPI) Snapshot(ctx context.Context, skipHead bool) (SnapshotResult, error) {
	m.ctrl.T.Helper()
...
func (m *MockAPI) TSDB(ctx context.Context) (TSDBResult, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "TSDB", ctx)
	ret0, _ := ret[0].(TSDBResult)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockAPI) Targets(ctx context.Context) (TargetsResult, error) {
	m.ctrl.T.Helper()
...
func (m *MockAPI) TargetsMetadata(ctx context.Context, matchTarget, metric, limit string) ([]MetricMetadata, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "TargetsMetadata", ctx, matchTarget, metric, limit)
	ret0, _ := ret[0].([]MetricMetadata)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockAPI) WalReplay(ctx context.Context) (WalReplayStatus, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "WalReplay", ctx)
	ret0, _ := ret[0].(WalReplayStatus)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// WalReplay indicates an expected call of WalReplay.
func (mr *MockAPIMockRecorder) WalReplay(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockapiClient) Do(arg0 context.Context, arg1 *http.Request) (*http.Response, []byte, Warnings, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Do", arg0, arg1)
	ret0, _ := ret[0].(*http.Response)
	ret1, _ := ret[1].([]byte)
	ret2, _ := ret[2].(Warnings)
	ret3, _ := ret[3].(error)
...
func (m *MockapiClient) DoGetFallback(ctx context.Context, u *url.URL, args url.Values) (*http.Response, []byte, Warnings, error) {
	m.ctrl.T.Helper()
